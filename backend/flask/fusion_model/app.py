...
dataset = load_dataset(
    "csv",
    data_files={
        "train": os.path.join("..", r"C:\Users\Pavan\Documents\MEDICAL VQA\medical_vqa\model", "trainpvqaimg.csv"),
        "test": os.path.join("..", r"C:\Users\Pavan\Documents\MEDICAL VQA\medical_vqa\model", "testpvqaimg.csv")
    }
)

with open(os.path.join("..", r"C:\Users\Pavan\Documents\MEDICAL VQA\medical_vqa\model", "unique_answers.txt")) as f:
...
class MultimodalCollator:
    ...
    def preprocess_images(self, images: List[str]):
        processed_images = self.preprocessor(
            images=[Image.open(os.path.join("..", r"C:\Users\Pavan\Desktop\medical project\backend\flask\fusion_model\uploads",   image_id + ".jpg")).convert('RGB') for image_id in images],
            return_tensors="pt",
        )
        return {
...
with open(r"C:\Users\Pavan\Desktop\medical project\modelcol.pkl", 'rb') as file:
